...
Olá candidato(a),
Este desafio faz parte do processo seletivo para a vaga de Desenvolvedor Backend no
Nubank. Nosso objetivo é avaliar sua capacidade de estruturar uma API RESTful
utilizando boas práticas, relacionamentos de entidades e persistência de dados com Spring
Boot e PostgreSQL.
